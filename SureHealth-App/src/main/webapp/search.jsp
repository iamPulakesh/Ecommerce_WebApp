...
<body>
	<%
	User u = (User) session.getAttribute("userobj");// retrive the user object from the session /access user data
	%>
	...
	<div class="container">
		<div class="row mt-2">
			...
			List<MedsDtls> list = dao.getMedsBySearch(ch);//show all medicines upon search
			for (MedsDtls m : list) {
			%>
